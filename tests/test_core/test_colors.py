...
def _reload_colors():
    ...
    from kanka_wiki_updater.core import colors as mod
...
class TestColorWrapping:
    def test_red_wraps_text(self):
        from kanka_wiki_updater.core.colors import red

        result = red('hello')
        assert 'hello' in result

    def test_green_wraps_text(self):
        from kanka_wiki_updater.core.colors import green

        result = green('world')
        assert 'world' in result

    def test_all_colors_exist(self):
        from kanka_wiki_updater.core.colors import bold, cyan, dim, green, magenta, red, yellow
...
class TestDisabledFallback:
    def test_identity_when_no_colorama(self):
        import kanka_wiki_updater.core.colors as colors_mod
...
class TestEnabledFlag:
    def test_enabled_is_boolean(self):
        from kanka_wiki_updater.core.colors import _ENABLED

        assert isinstance(_ENABLED, bool)

    def test_identity_function_exists(self):
        from kanka_wiki_updater.core.colors import _identity
