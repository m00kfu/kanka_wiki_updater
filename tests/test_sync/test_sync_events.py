...
def rw():
    ...
    import kanka_wiki_updater.review.web as rw_mod
    yield rw_mod
...
def so():
    ...
    from kanka_wiki_updater.sync import sync_orchestrator as so_mod
    yield so_mod
...
class TestSSEOutputWithEntityProgress:
    ...
    def test_entity_progress_events_appear_in_stream(self, app_with_queue):
        ...
        from kanka_wiki_updater.review.web import EVENT_ENTITY_PROGRESS
