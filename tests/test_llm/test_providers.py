...
from kanka_wiki_updater.llm.providers import (
    LLMError,
    _extract_json,
    chat_json,
    gemini_chat,
...
class TestGeminiChat:
    ...
    def setup_gemini_env(self):
        import kanka_wiki_updater.core.config as config_mod
        import kanka_wiki_updater.llm.providers as llm_mod
        ...
        try:
            with patch('kanka_wiki_updater.llm.providers.config') as mock_cfg:
                ...
                import kanka_wiki_updater.llm.providers as llm_mod2
            ...
            import kanka_wiki_updater.llm.providers as llm_mod3
    ...
    @patch('kanka_wiki_updater.llm.providers.requests.post')
...
class TestConfigValidation:
    ...
    def test_gemini_without_api_key_raises(self):
        ...
        try:
            with mock.patch('kanka_wiki_updater.core.config.load_dotenv', return_value=None):
