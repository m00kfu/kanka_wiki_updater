...
class TestCancellationEdgeCases:
    ...
    def test_cancel_event_prevents_new_journal_processing(self):
        ...
        from kanka_wiki_updater.ingest_journal import _default_callbacks, run_ingest
        ...
        with umock.patch('kanka_wiki_updater.ingest_journal.KankaClient', return_value=mock_client):
            summary = run_ingest(
                client=mock_client,
                callbacks=cbs,
...
class TestSSECallbackEmitter:
    ...
    def test_emitter_appends_to_buffer(self, app_with_queue):
        from kanka_wiki_updater.review_web import EVENT_ENTITY_PROGRESS, _SSECallbackEmitter
    ...
    def test_emitter_proposal_pushed_event(self, app_with_queue):
        from kanka_wiki_updater.review_web import EVENT_PROPOSAL_PUSHED, _SSECallbackEmitter
    ...
    def test_emitter_status_change_event(self, app_with_queue):
        from kanka_wiki_updater.review_web import EVENT_STATUS_CHANGE, _SSECallbackEmitter
