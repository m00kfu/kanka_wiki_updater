...
This project is indexed by GitNexus as **kanka_wiki_updater** (932 symbols, 1565 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
