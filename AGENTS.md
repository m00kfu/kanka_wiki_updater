...
This project is indexed by GitNexus as **kanka_wiki_updater** (1014 symbols, 1731 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
