...
This project is indexed by GitNexus as **kanka_wiki_updater** (986 symbols, 1689 relationships, 22 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
