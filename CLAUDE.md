...
This project is indexed by GitNexus as **kanka_wiki_updater** (1032 symbols, 1766 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
